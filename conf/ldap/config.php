...
$servers->setValue('server','base',array('dc=cluster'));
...
/* The DN of the user for phpLDAPadmin to bind with. For anonymous binds or
   ...
   binds. */
$servers->setValue('login','bind_id','cn=admin,dc=cluster');
#  $servers->setValue('login','bind_id','cn=Manager,dc=cluster');
...
#  $servers->setValue('auto_number','search_base','ou=People,dc=cluster');
...
#   'uid=stran,ou=People,dc=cluster',
#   '(&(gidNumber=811)(objectClass=groupOfNames))',
#   '(|(uidNumber=200)(uidNumber=201))',
#   'cn=callcenter,ou=Group,dc=cluster'));
